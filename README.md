...
- For 3.4.0 - 3.7.x (current latest stable release), use the code from the **master** branch.
- For development branches (like 3.8.0), use the code from the **3.8.0** branch. This branch is in development alongside the accompanying Rocket.Chat branch, so some bugs can be expected.
